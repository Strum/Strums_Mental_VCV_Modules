...
MentalBinaryDecoderWidget::MentalBinaryDecoderWidget() {
  ...
  addInput(createInput<PJ301MPort>(Vec(3, top_space), module, MentalBinaryDecoder::INPUT_1));
  addInput(createInput<PJ301MPort>(Vec(3, top_space + spacing), module, MentalBinaryDecoder::INPUT_2));
  addInput(createInput<PJ301MPort>(Vec(3, top_space + spacing * 2), module, MentalBinaryDecoder::INPUT_4));
