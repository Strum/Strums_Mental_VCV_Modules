...
MentalChordWidget::MentalChordWidget() {
  ...
  addInput(createInput<PJ301MPort>(Vec(63, 50), module, MentalChord::VOICING_CV_INPUT));
  
  addInput(createInput<PJ301MPort>(Vec(3, 130), module, MentalChord::FLAT_3RD_INPUT));
  addInput(createInput<PJ301MPort>(Vec(3, 155), module, MentalChord::FLAT_5TH_INPUT));
  addInput(createInput<PJ301MPort>(Vec(3, 180), module, MentalChord::FLAT_7TH_INPUT));
  
  addInput(createInput<PJ301MPort>(Vec(3, 210), module, MentalChord::SUS_2_INPUT));
  addInput(createInput<PJ301MPort>(Vec(3, 235), module, MentalChord::SUS_4_INPUT));
  addInput(createInput<PJ301MPort>(Vec(3, 260), module, MentalChord::SIX_FOR_5_INPUT));
  addInput(createInput<PJ301MPort>(Vec(3, 285), module, MentalChord::ONE_FOR_7_INPUT));
  addInput(createInput<PJ301MPort>(Vec(3, 310), module, MentalChord::FLAT_9_INPUT));
  addInput(createInput<PJ301MPort>(Vec(3, 335), module, MentalChord::SHARP_9_INPUT));
  addInput(createInput<PJ301MPort>(Vec(33, 322), module, MentalChord::SIX_FOR_7_INPUT));
  addInput(createInput<PJ301MPort>(Vec(33, 347), module, MentalChord::SHARP_5_INPUT));
  
  
  addOutput(createOutput<PJ301MPort>(Vec(63, 100), module, MentalChord::OUTPUT_ROOT));
  addOutput(createOutput<PJ301MPort>(Vec(63, 125), module, MentalChord::OUTPUT_THIRD));
  addOutput(createOutput<PJ301MPort>(Vec(63, 150), module, MentalChord::OUTPUT_FIFTH));
  addOutput(createOutput<PJ301MPort>(Vec(63, 175), module, MentalChord::OUTPUT_SEVENTH));  
    
  addOutput(createOutput<PJ301MPort>(Vec(63, 250), module, MentalChord::OUTPUT_1));
  addOutput(createOutput<PJ301MPort>(Vec(63, 275), module, MentalChord::OUTPUT_2));
  addOutput(createOutput<PJ301MPort>(Vec(63, 300), module, MentalChord::OUTPUT_3));
  addOutput(createOutput<PJ301MPort>(Vec(63, 325), module, MentalChord::OUTPUT_4));
