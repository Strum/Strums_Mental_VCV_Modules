...
MasterClock::MasterClock()
{
  ...
  configParam(MasterClock::TEMPO_PARAM, 40.0, 250.0, 120.0, "");
  configParam(MasterClock::TIMESIGTOP_PARAM,2.0, 15.0, 4.0, "");
  configParam(MasterClock::TIMESIGBOTTOM_PARAM,0.0, 3.0, 1.0, "");
  configParam(MasterClock::RESET_BUTTON, 0.0, 1.0, 0.0, "");
  configParam(MasterClock::RUN_SWITCH, 0.0, 1.0, 0.0, "");
}

void MasterClock::process(const ProcessArgs& args)
{
...
//////////////////////////////////
struct MasterClockWidget : ModuleWidget {
  MasterClockWidget(MasterClock *module)
{

  setModule(module);

  setPanel(APP->window->loadSvg(asset::plugin(pluginInstance, "res/MasterClock.svg")));

    addParam(createParam<MedKnob>(Vec(2, 20), module, MasterClock::TEMPO_PARAM));
    addParam(createParam<MedKnob>(Vec(2, 50), module, MasterClock::TIMESIGTOP_PARAM));
    addParam(createParam<MedKnob>(Vec(2, 80), module, MasterClock::TIMESIGBOTTOM_PARAM));

    addOutput(createOutput<GateOutPort>(Vec(90, 110), module, MasterClock::BEAT_OUT));
    addOutput(createOutput<GateOutPort>(Vec(90, 140), module, MasterClock::BAR_OUT));
    addOutput(createOutput<GateOutPort>(Vec(90, 170), module, MasterClock::EIGHTHS_OUT));
    addOutput(createOutput<GateOutPort>(Vec(90, 200), module, MasterClock::SIXTEENTHS_OUT));

    addParam(createParam<LEDButton>(Vec(5, 140), module, MasterClock::RESET_BUTTON));
    addChild(createLight<MedLight<BlueLED>>(Vec(10, 145), module, MasterClock::RESET_LED));

    addParam(createParam<LEDButton>(Vec(5, 110), module, MasterClock::RUN_SWITCH));
    addChild(createLight<MedLight<BlueLED>>(Vec(10, 115), module, MasterClock::RUN_LED));
...
Model *modelMasterClock = createModel<MasterClock, MasterClockWidget>("MasterClock");
