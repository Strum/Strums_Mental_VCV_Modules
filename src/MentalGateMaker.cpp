...
MentalGateMakerWidget::MentalGateMakerWidget() {
  ...
  int offset = 30;
  addInput(createInput<PJ301MPort>(Vec(3, 80 + offset), module, MentalGateMaker::CLK_IN));
	addInput(createInput<PJ301MPort>(Vec(3, 110 + offset), module, MentalGateMaker::RESET_IN));
  addParam(createParam<LEDButton>(Vec(35, 110 + offset), module, MentalGateMaker::RST_BUTTON, 0.0, 1.0, 0.0));
  addInput(createInput<PJ301MPort>(Vec(3, 140 + offset), module, MentalGateMaker::TRIGGER_IN));
  ...
  addOutput(createOutput<PJ301MPort>(Vec(93, 140), module, MentalGateMaker::TRIG_OUT));
  addOutput(createOutput<PJ301MPort>(Vec(93, 170), module, MentalGateMaker::FINISH_OUT)); 
