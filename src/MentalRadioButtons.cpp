...
MentalRadioButtonsWidget::MentalRadioButtonsWidget() {
  ...
  for (int i = 0; i < 7 ; i++)
  {  
    addInput(createInput<InPort>(Vec(3, top_space + spacing * i), module, MentalRadioButtons::INS1 + i));
    addOutput(createOutput<OutPort>(Vec(63, top_space + spacing * i), module, MentalRadioButtons::OUTPUT + i));
    ...
    addChild(createLight<MediumLight<GreenLight>>(Vec(40, top_space + 8 + spacing * i), module, MentalRadioButtons::BUTTON_LEDS + i));
	  ...
	  /// group 2
   addInput(createInput<InPort>(Vec(3, 10 + group_offset + spacing * i), module, MentalRadioButtons::INS2 + i)); 
   addOutput(createOutput<OutPort>(Vec(63, 10 + group_offset +  spacing * i), module, MentalRadioButtons::BUTTON2_OUT + i));
